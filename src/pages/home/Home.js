    ...
    <div>
      <header class="header">
        <div class="header__container">
          <h1 class="heading-primary">Dillon Polley</h1>

          <p class="heading-sub u-bold-text u-center-text">
            {`<Full Stack Developer />`}
          </p>

          <div class="header__buttons u-margin-top-medium">
            <a href="#section-about" class="btn btn--yellow btn--animated">
              Who Am I?
            </a>

            <a href="contact.html" class="btn btn--yellow btn--animated">
              Contact Me
            </a>
          </div>
        </div>
        ...
        <img
          class="header__speaker"
          src="img/Speaker_Picture_Both.png"
      ...
      <main>
        <section id="section-about" class="section--about">
          ...
          <p class="paragraph paragraph__padded paragraph__about">
            ...
            classmates, and friends. I enjoy playing guitar, year-round
            Christmas, cooking, and running in my free time.
          </p>
        </section>

        <section class="section--skills">
          <h2 class="heading heading__white">
            A Man of Many Hats
            <span class="u-underline__blue u-underline__top"></span>
            <span class="u-underline__yellow u-underline__bottom"></span>
          </h2>

          <p class="paragraph paragraph__padded paragraph__skills u-margin-bottom-medium">
          ...
          <div class="skills__container">
            <div class="box__blue">
              <h2 class="heading__medium u-center-text u-margin-bottom-medium">
                Web Design
              </h2>

              <p class="box__text u-margin-bottom-small">
              ...
              <p class="box__text u-bold-text u-margin-bottom-small">
                Design tools:
              </p>

              <p class="box__text">Adobe Xd</p>
              <p class="box__text">Photoshop</p>
              <p class="box__text">Pencil and Notebook</p>
            </div>

            <div class="box__yellow">
              <h2 class="heading__medium u-center-text u-margin-bottom-medium">
                Front End
              </h2>
        ...
        <section class="section--projects section--projects__original u-margin-bottom-medium">
          <h2 class="heading u-margin-bottom-small">
            My Work
            <span class="u-underline__yellow u-underline__top"></span>
            <span class="u-underline__blue u-underline__bottom"></span>
          ...
          <div
            id="projects"
            class="projects__container projects__container--original"
          >
            <div class="box box__yellow box__small">
              <h3 class="heading__small">Natours</h3>
              ...
              <a
                ...
                class="btn btn--blue btn--animated box__button u-margin-top-medium"
              >
                Visit Site
              </a>
            </div>

            <div class="box box__blue box__small">
              <h3 class="heading__small">Total Titans</h3>
              ...
              <a
                ...
                class="btn btn--yellow btn--animated box__button u-margin-top-medium"
              >
                Visit Site
              </a>
            </div>
            ...
            <div class="box box__yellow box__small">
              <h3 class="heading__small">Trillo</h3>
            ...
            <div class="box box__blue box__large">
              <h3 class="heading__small">Fight Life</h3>
            ...
            <div class="box box__yellow box__large">
              <h3 class="heading__small">SV Marriage Cards</h3>
            ...
            <div class="box box__blue box__small box__hidden">
              <h3 class="heading__small">Nexter</h3>
            ...
            <div id="hidden" class="box box__yellow box__small box__hidden">
              <h3 class="heading__small">Developer Match</h3>
            ...
            <div id="hidden" class="box box__blue box__small box__hidden">
              <h3 class="heading__small">Connect 4</h3>

              <p class="box__text">
                Midterm project for N320 media application development. Classic
                board game.
              </p>
            ...
            <div id="hidden" class="box box__yellow box__large box__hidden">
              <h3 class="heading__small">Travel-Fly</h3>
            ...
            <div id="hidden" class="box box__blue box__large box__hidden">
              <h3 class="heading__small">My Money</h3>
          ...
          <a
            id="view--all"
            class="btn btn--yellow btn--animated projects__button"
          >
            View All
          </a>

          <a id="view--less" class="u-display-none">
            View Less
          </a>
        </section>
      </main>
      ...
      <footer class="footer">
        <p class="paragraph margin u-center-text">
          Did we just become best friends? Yep. Now come say hi so we can get in
          touch!
        </p>

        <a href="contact.html" class="btn btn--dark btn--animated">
          Contact Me
        </a>
      ...
      <section class="section--copyright u-center-text">
